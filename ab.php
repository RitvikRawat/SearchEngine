	...
	<div class="col-sm-10 col-sm-offset-1" style="padding-top: 3%; padding-bottom: 2%">
        ...
        if (window.SpeechRecognition === null) {
          ...
          document.getElementById('clear-all').addEventListener('click', function() {
			...
			?><br><center><button type="button" class="btn">
			<a href="<?php echo $_SERVER['PHP_SELF'].'?searchbox='.$query.'&startrow='.($startrow-10); ?>">Prev</a></button>
	              ...
	              <form class="form-horizontal" role="form" method="get" action="a.php">
	                    ...
	                    <div class="form-group">
	                        <div class="col-sm-offset-3 col-sm-6">
	                            ...
	                            <i class="fa fa-fw fa-search"></i>&nbsp Search Images</button>
	                        	</center>
	                        </div>
	                    </div>
	                </form>
...
-->
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-6">
                            <center><button type="submit" name="search" class="btn"><i class="fa fa-fw fa-search"></i>&nbsp Search Forms</button>
                              </center>
                        </div>
                    </div>
                </form>
